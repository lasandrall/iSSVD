...
#main function
def issvd(X,standr=False,pointwise=True,steps=100,size=0.5,vthr = 0.7, ssthr=[0.6,0.8],nbicluster=10,rows_nc=True,cols_nc=True,col_overlap=False,row_overlap=False,pceru=0.1,pcerv=0.1
          ,merr=1e-4,iters=100):
